...
// APIClient manages communication with the AlphaSOC API API v1.0
...
type APIClient struct {
	...
	DataProcessingApi *DataProcessingApiService
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	c.DataProcessingApi = (*DataProcessingApiService)(&c.common)
