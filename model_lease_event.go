...
// LeaseEvent struct for LeaseEvent
...
func (o LeaseEvent) MarshalJSON() ([]byte, error) {
...
type NullableLeaseEvent struct {
	value *LeaseEvent
	isSet bool
}

func (v NullableLeaseEvent) Get() *LeaseEvent {
	return v.value
}

func (v *NullableLeaseEvent) Set(val *LeaseEvent) {
	v.value = val
	v.isSet = true
}

func (v NullableLeaseEvent) IsSet() bool {
	return v.isSet
}

func (v *NullableLeaseEvent) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLeaseEvent(val *LeaseEvent) *NullableLeaseEvent {
	return &NullableLeaseEvent{value: val, isSet: true}
}

func (v NullableLeaseEvent) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLeaseEvent) UnmarshalJSON(src []byte) error {
	v.isSet = true
